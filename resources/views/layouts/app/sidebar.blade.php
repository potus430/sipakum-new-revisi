        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Pendaftaran')" class="grid">
                <flux:sidebar.item icon="scale" :href="route('pidana.index')"
                    :current="request()->routeIs('pidana.index')" wire:navigate>
                    {{ __('Pidana') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="document-text" :href="route('perdata.index')"
                    :current="request()->routeIs('perdata.index')" wire:navigate>
                    {{ __('Perdata') }}
                </flux:sidebar.item>
